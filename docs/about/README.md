<div class="testimonials">
  ...
  <div class="testimonial" style="display: flex">
    <div class="img">
      <img src="../images/testimonials/kelsey@2.png" alt="" width="120px">
    </div>
    <div class="quote">
      "If Kubernetes is an electrical grid, then Knative is its light switch."<br><br>
  ...
  <div class="testimonial">
    ...
    <div class="quote">
      "I often think of Knative as part of 'Serverless 2.0.' It combines the good things about serverless with a loosening of constraints around execution time and availability of resources."<br><br>
      -Michael Behrendt, Distinguished Engineer and Chief Architect of Serverless and Cloud Functions for IBM.<br><br>
  ...
  <div class="testimonial">
    ...
    <div class="quote">
      "The amount of internal work needed to use Knative is minuscule"<br><br>
