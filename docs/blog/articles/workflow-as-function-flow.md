...
![Workflow as Function Flow](images/workflow-function-flow-concept.png)
...
![Slice workflow into functions](images/workflow-function-flow-function-slice.png)
...
![Inputs and outputs as events](images/workflow-function-flow-function-io.png)
...
![Slice workflow into functions](images/workflow-function-flow-function-example-bpmn.png)
*BPMN*

![Slice workflow into functions](images/workflow-function-flow-function-example-sw.png)
...
[![YouTube Video](https://img.youtube.com/vi/DpiVxRBq7qo/0.jpg)](https://youtu.be/DpiVxRBq7qo)
