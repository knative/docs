...
In the world of microservices and REST APIs, we often refer to requests as the primary method of communication between services. However, in an event-driven architecture, the smallest unit is an event. Knative Eventing adheres to the CloudEvents specification, making it essential to understand this concept before moving forward. Learn more about CloudEvents [here](https://docs.google.com/document/d/1xvXeTo5yN5PbULDtGrExRAJEMdZ0ztvg0cJcgNQvWrQ/edit) before proceeding!
...
???+ success "Verify"
    ...
    The trigger `temp-trigger` should have `READY` status as `True`.
