...
See the
[Kafka Source](https://github.com/knative/eventing-contrib/tree/release-0.9/kafka/source)
example.
...
See the
[CamelSource](https://github.com/knative/eventing-contrib/tree/release-0.9/camel/source/samples)
example.
