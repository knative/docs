...
[Eventing work group](../community/WORKING-GROUPS.md#events).
...
- `args`: `[]string` Command-line arguments. If the `--sink` flag is excluded,
  `--sink` is set to the DNS address of the `sink` object by default.
