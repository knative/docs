...
1. Make sure that you have a functioning Kubernetes cluster. See the
   ...
   - If your Kubernetes cluster comes with pre-installed Istio, make sure it has
     ...
     [here](https://github.com/knative/serving/tree/master/third_party).
...
[code samples](./samples/_index.md), check the requirements of the sample and
make sure you do not need a namespace before you delete `event-example`. You can
always reuse your namespaces.
