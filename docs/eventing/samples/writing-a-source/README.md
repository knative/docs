...
"the hard way", without using helper objects like ContainerSource ( Go to [ContainerSource sample](../container-source/README.md) to see how to create an event source using ContainerSource ).
