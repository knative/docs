...
| [Heartbeats](https://github.com/knative/eventing-contrib/tree/release-0.9/cmd/heartbeats)              | Proof of Concept   | None        | Uses an in-memory timer to produce events at the specified interval.                                                         |
...
| [WebSocket](https://github.com/knative/eventing-contrib/tree/release-0.9/cmd/websocketsource)          | Active Development | None        | Opens a WebSocket to the specified source and packages each received message as a Knative event.                             |
