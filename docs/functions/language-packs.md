...
for the template files. The Knative Sandbox maintains a set of [example templates](https://github.com/knative-extension/func-tastic){target=_blank} which can be used during project creation.
...
```{ .console }
func create myfunc -l nodejs -t metacontroller --repository https://github.com/knative-extension/func-tastic
```
...
```{ .console }
func repository add knative https://github.com/knative-extension/func-tastic
```
