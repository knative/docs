...
!!! note "Install a default Channel"
...
??? "GCP Sources"
    ...
    !!! tip "To learn more about the Cloud Scheduler source, try [the sample](../eventing/samples/cloud-scheduler-source/README.md)."
