...
|----------------------|-------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------|
| v1.5.0               | v1.5(v1.5.0)<br/>v1.4(v1.4.0)<br/>v1.3(v1.3.0, v1.3.1 and v1.3.2)<br/>v1.2(v1.2.0, v1.2.1, v1.2.2, v1.2.3, v1.2.4 and v1.2.5) | v1.5(v1.5.0)<br/>v1.4(v1.4.0 and v1.4.1)<br/>v1.3(v1.3.0, v1.3.1, v1.3.2 and v1.3.3)<br/>v1.2(v1.2.0, v1.2.1, v1.2.2 and v1.2.3) |
