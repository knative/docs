...
|----------|------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| v1.17    | v1.17.0<br/>v1.16.0 and v1.16.1<br/>v1.15.0, v1.15.1, v1.15.2 and v1.15.3<br/>v1.14.0, v1.14.1 and v1.14.2 | v1.17.0<br/>v1.16.0, v1.16.1, v1.16.2 and v1.16.0<br/>v1.15.0, v1.15.1, v1.15.2 and v1.15.3<br/>v1.14.0, v1.14.1, v1.14.2, v1.14.3, v1.14.4, v1.14.5, v1.14.6 and v1.14.7 |
