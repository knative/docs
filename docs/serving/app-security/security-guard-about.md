...
See a [Security-Behavior Monitoring Quickstart](./security-guard-quickstart.md).

See Readme files in the [Security Guard Github Repository](knative.dev/security-guard).
