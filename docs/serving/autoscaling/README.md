...
* Configure your Knative Service to use [container-freezer](container-freezer.md), which will keep frozen pod when pod's traffic drops to zero. The most valuable benefit is reducing the cold-start time within this configuration.
