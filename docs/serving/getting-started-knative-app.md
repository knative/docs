...
<<<<<<< HEAD
Alternatively, to deploy an app using Knative, you can also create the configuration in a YAML file that defines a service.
=======
...
>>>>>>> 03c6f8ea... Getting started: Added examples with using "kn"
