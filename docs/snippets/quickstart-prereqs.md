...
!!! warning
    ...
    For a production ready installation, see the [YAML-based installation](../versioned/install/yaml-install/)
    or the [Knative Operator installation](../versioned/install/operator/).
