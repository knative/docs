...
!!! warning
    ...
    For a production ready installation, see the [YAML-based installation](../versioned/install/yaml-install/README.md)
    or the [Knative Operator installation](../versioned/install/operator/knative-with-operators.md).
