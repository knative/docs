...
**Install files in bold are the recommended standard install suitable for most
use cases.**
...
1. To install a Knative component by specifying the filename in the
   ...
   - To install multiple components, append additional `--filename [FILENAME]`
