...
```
curl -LO https://github.com/knative/serving/releases/download/v0.2.2/istio.yaml
kubectl create configmap istio-chart-080 --from-file=istio.yaml

curl -LO https://github.com/knative/serving/releases/download/v0.2.2/release.yaml
