...
This guide demonstrates how to update an application to a new version using a
blue/green traffic routing sample. With Knative, you can safely reroute traffic
